...
public class ScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = getCurrentDate();
        list = MyManager.querySchInfoByDate(date);
    ...
    private void showAddScheduleDialog() {
        ...
        dialogBuilder.setPositiveButton("添加", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                MyDataBase info = new MyDataBase(null,title,place,date,time,description);
                MyManager.addSchInfo(info);
                list.add(info);
                list = MyManager.querySchInfoByDate(date);
                adapter.setScheduleList(list);
                adapter.notifyDataSetChanged();
